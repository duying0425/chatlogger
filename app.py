...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card-title-group { display: flex; align-items: center; gap: 8px; min-width: 0; flex: 1; overflow: hidden; }
        .card-title-group .name { font-size: 15px; font-weight: 600; color: #1f2329; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 320px; }
        .btn-edit-name { cursor: pointer; font-size: 13px; opacity: 0.6; padding: 2px 4px; border-radius: 4px; transition: opacity 0.2s, background 0.2s; user-select: none; flex-shrink: 0; }
        .btn-edit-name:hover { opacity: 1; background: #e5e6eb; }
        .feishu-origin-tag { background: #f2f3f5; color: #646a73; padding: 2px 8px; border-radius: 4px; font-size: 11px; max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; flex-shrink: 0; }
        
        .card-primary-actions { display: flex; align-items: center; gap: 8px; flex-shrink: 0; margin-left: auto; }
        .btn-preview-tag { display: inline-flex; align-items: center; gap: 4px; padding: 6px 14px; border-radius: 8px; font-size: 12px; background: #e8f3ff; color: #3370ff; font-weight: 500; text-decoration: none; cursor: pointer; transition: all 0.2s; border: 1px solid rgba(51, 112, 255, 0.2); white-space: nowrap; }
        .btn-preview-tag:hover { background: #3370ff; color: white; border-color: #3370ff; }
        .btn-sync { padding: 6px 16px; background: #00b42a; color: white; border: none; border-radius: 8px; font-size: 13px; cursor: pointer; transition: all 0.2s; font-weight: 500; white-space: nowrap; }
        ...
        /* 卡片底部：辅助工具与右对齐删除操作 */
        .card-footer { display: flex; justify-content: space-between; align-items: center; gap: 12px; padding-top: 2px; }
        ...
        .footer-right { margin-left: auto; flex-shrink: 0; }
        .btn-delete-clean { padding: 4px 10px; background: transparent; color: #8f959e; border: 1px solid transparent; border-radius: 6px; font-size: 12px; cursor: pointer; transition: all 0.2s; white-space: nowrap; }
        .btn-delete-clean:hover { background: #ffece8; color: #f53f3f; border-color: #ffd6d0; }

        /* 状态徽章 */
        .badge { display: inline-flex; align-items: center; gap: 5px; padding: 2px 8px; border-radius: 10px; font-size: 11px; font-weight: 500; flex-shrink: 0; }
                ...
                <div class="chat-item" id="chat-{{ chat.chat_id }}" data-chat-id="{{ chat.chat_id }}" data-latest-time="{{ chat.latest_message_time or 0 }}">
                    <div class="card-header">
                        ...
                        <div class="card-primary-actions">
                            <a href="/cache/{{ chat.chat_id }}/view" target="_blank" class="btn-preview-tag" id="preview-btn-{{ chat.chat_id }}" {% if not chat.has_cache %}style="display:none;"{% endif %} title="点击在新标签页查看本地 Markdown 归档与附件">📑 查看归档</a>
